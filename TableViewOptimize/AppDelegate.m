...
//    self.window.rootViewController = self.tableViewController;
    tableViewController_ = [[TFTableViewController alloc] init];
    navigationController_ = [[UINavigationController alloc] initWithRootViewController:tableViewController_];
